...
# **Table of Contents**
# 
# [Comparison of Scores in Each Student Category Using Bar Plots](#Comparison-of-Scores-in-Each-Student-Category-Using-Bar-Plots)  
# * [Gender](#Gender)
# * [Ethnicity](#Ethnicity)
# * [English-Language Fluency](#English-Language-Fluency)
# * [Economic Status](#Economic-Status)
# * [Disability Status](#Disability-Status)
# * [Parent Education](#Parent-Education)
# 
# [Comparison in Best or Worst Performance Groups Using Bar Plots](#Comparison-in-Best-or-Worst-Performance-Groups-Using-Bar-Plots)
# * [Overall Characteristics for Counties](#Overall-Characteristics-for-Counties)
# * [House Prices](#House-Prices)
# * [Student Categories](#Student-Categories)
# 
# [Correlations Using Scatterplots](#Correlations-Using-Scatterplots)
# * [Test Achievements vs. House Prices](#Test-Achievements-vs.-House-Prices)
# 
...
# **Type of graphs**
# 
# For utilizing advanced features, we used the [**seaborn**](https://seaborn.pydata.org/index.html), [**Bokeh**](http://bokeh.pydata.org/en/latest/), and [**Plotly**](https://plot.ly/python/) libraries (To Be Developed: TBD).  
...
drawBarplotCatplot2(irvine_district_elementary_ex, 'All Students', saturation_p, asepct_p, "School Name", "Performance Group Percentage", "Performance Group")
...
drawBarplotCatplot2(irvine_district_middle_ex, 'All Students', saturation_p, asepct_p, "School Name", "Performance Group Percentage", "Performance Group")
...
drawBarplotCatplot2(irvine_district_high_ex, 'All Students', saturation_p, asepct_p, "School Name", "Performance Group Percentage", "Performance Group")
